	...
	<tr>
		<td align=center class="tablebody1">
			<table border="0" cellpadding="0" cellspacing="1" align="center" Style="Width:90%">
				...
				<tr>
					<td class="tablebody2" style="text-align:left;">经验：<%=Dvbbs.UserSession.documentElement.selectSingleNode("userinfo/@userep").text%></td>
				</tr>
				<tr>
...
Sub UserCenter()
	If Request("react") = "Savechange" Then
		...
		If userep>0 And CCur(Dvbbs.UserSession.documentElement.selectSingleNode("userinfo/@userep").text)<CCur(Dvbbs.Forum_setting(94)) Then ErrMsg="你的经验不足。"
