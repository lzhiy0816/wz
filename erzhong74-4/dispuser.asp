...
If UserInfo(18)="" Or UserInfo(18)="," Then
	TempPart3=Replace(TempPart3,"{$UserGroup}","没有参与圈子活动")
Else
	TempPart3=Replace(TempPart3,"{$UserGroup}","<a href=""IndivGroup_List.asp?action=usergrouplist&userid="&ShowUserid&""" target=""_blank"">参与的圈子</a>")
End If
