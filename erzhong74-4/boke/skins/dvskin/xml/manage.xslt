...
<div class="td1" style="width:600px;height:153px;clear:both;">
	...
	<form method="post" action="?Action=Login" name="apply">
		...
		<ul>
			...
			<li>验&nbsp;&nbsp;证&nbsp;码：{$Dv_GetCode}<!--<input type="text" name="codestr" maxlength="4" size="4">&nbsp;<img src="DV_getcode.asp">-->
			</li>
		</ul>
		<BR/>
...
<FORM METHOD=POST ACTION="?s=5&t=4&Action=Save">
	...
	<li>关&nbsp;&nbsp;键&nbsp;字：<input type="text" name="KeyWord" value="{$KeyWord}"/></li>
	<li>替换文本：<input type="text" name="nKeyWord" value="{$nKeyWord}"/></li>
	<li>链接地址：<input type="text" name="LinkUrl" value="{$LinkUrl}"/><input type="checkbox" name="NewWindows" value="1" {$NewWindows}/>新窗口打开</li>
	<li>链接标题：<input type="text" name="LinkTitle" value="{$LinkTitle}"/><input type="submit" name="submit" value="提交关键字"/></li>
</FORM>
<div id="mainlist">
<hr style="clear:both;"/>
<ul>
<li class="Set33"><B>关键字</B></li>
<li class="Set33"><B>替换文本</B></li>
<li class="Set44"><B>链接地址</B></li>
<li class="Set33"><B>管理操作</B></li>
</ul>
...
<div id="main" style="text-align:left;">
	<div class="topic">评论管理</div>
	<div style="margin:10px 0px 10px 0px;">
	<FORM METHOD=POST ACTION="?s=2">
		关键字：<input type="text" size="15" name="KeyWord" value="{$KeyWord}"/>
		<input type="submit" value="查询" name="submit"/><br/>
	</FORM>
</div>
...
<div class="list_body" style="margin-bottom:10px;">
	<hr class="post">
		...
		<div class="list3" style="text-align:left;">全选	</div>
		<div class="list2" style="text-align:left;"><input type="radio" value="0" name="iTopic" checked />删除</div>
		<div class="list3" style="text-align:left;">
			<input type="submit" name="action" value="执行操作" onclick="if(confirm('确定执行选定的操作吗?')==false)return false;" />
		</div>
</div>
