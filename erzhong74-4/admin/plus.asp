...
<tr><td height="23" colspan="2" class=td1> 能使用插件的最低经验&nbsp;&nbsp;<input type=text name="Plus_UserEP" value=<%=PSetting(3)(6)%> size=5></td></tr>
...
<tr><td height="23" colspan="2" class=td1> 每次使用插件经验变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserEP" value=<%=PSetting(3)(10)%> size=5></td></tr>
...
<tr><td height="23" colspan="2" class=td1> 能使用插件的最低经验&nbsp;&nbsp;<input type=text name="Plus_UserEP" value=0 size=5></td></tr>
...
<tr><td height="23" colspan="2" class=td1> 每次使用插件经验变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserEP" value=0 size=5></td></tr>
