...
<tr><th colspan="5">论坛高级设置 → <%=rs("boardtype")%></th></tr>
<tr> 
...
%>
 <%=i%>点：<input type="checkbox" class="checkbox" name="Board_Setting(22)<%=i%>" value="1" <%If Board_Setting(22)(i)="1" Then %>checked<%End If%>>开
