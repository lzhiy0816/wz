  ...
  <tr>
    <td valign="top" style="padding-top:10px;" class="left_color" id="menubar">
			<div id="left0" style="display:"> 
				...
				<a href=CaptchaSet.asp target="frmright">验证码显示设置</a>
				...
				<a href="indivGroup.asp" target="frmright">论坛圈子管理</a>
				<a href="myspace.asp" target="frmright">个人空间管理</a>
			...
			<div id="left8" style="display:none"> 
				...
				<a href="indivGroup.asp" target="frmright" alt="">个性圈子管理</a>
				<a href="../bokeadmin.asp" target="frmright" alt="">论坛博客管理</a>
				<a href="myspace.asp" target="frmright" alt="">个人空间管理</a>
