...
Dim UserFlashGet
UserFlashGet = 0 '指定FLASHGET下载  : 0为关闭，1为开启
Const FlashGetID = "2187"
	...
	Private Function Dv_UbbCode_U(strText,PostUserGroup,Flag)	'(帖子内容，用户组，是否开放图片标签)
		...
		If Dvbbs.BoardID>0 Then
			...
			If UserFlashGet=1 Then
				If re.Test(s) Then
					Set match = re.Execute(s)
					downUrl = ServerHttp&"viewFile.asp?BoardID="&Dvbbs.Boardid&"&ID="&re.Replace(match.item(0),"$4")
					downUrl = FlashgetEncode(downUrl,FlashGetID)
					Set match = Nothing
					If RowStr="" Then
						UploadAddr = "<tr><td colspan=""2"" height=""20"" class=""tablebody1""><img "& DV_UBB_TITLE &" src=""skins/default/filetype/$1.gif"" border=""0"" /><a href=""viewFile.asp?BoardID="&Dvbbs.Boardid&"&ID=$4"" target=""_blank"">[点击浏览该文件:$3]</a> | <img "& DV_UBB_TITLE &" src=""skins/default/fgdown.gif"" border=""0"" /><a href=""#"" onClick=""ConvertURL2FG('"&downUrl&"','"&ServerHttp&"viewFile.asp?BoardID="&Dvbbs.Boardid&"&ID=$4',"&FlashGetID&");return false;"" fg="""&downUrl&""" oncontextmenu=""Flashget_SetHref(this)"">[快车下载]</a></td></tr>"
					Else
						UploadAddr = "<tr><td colspan=""2"" height=""20"" class=""tablebody1""><img "& DV_UBB_TITLE &" src=""skins/default/filetype/$1.gif"" border=""0"" /><a href=""viewFile.asp?BoardID="&Dvbbs.Boardid&"&ID=$4"" target=""_blank"" onClick=""return "&PromptInfo&";"">[点击浏览该文件:$3]</a> | <img "& DV_UBB_TITLE &" src=""skins/default/fgdown.gif"" border=""0"" /><a href=""#"" onClick=""if("&PromptInfo&") {ConvertURL2FG('"&downUrl&"','"&ServerHttp&"viewFile.asp?BoardID="&Dvbbs.Boardid&"&ID=$4',"&FlashGetID&");} return false;"" fg="""&downUrl&""" oncontextmenu=""Flashget_SetHref(this)"">[快车下载]</a></td></tr>"
					End If
				End If
			Else
				If RowStr="" Then
		...
		If UserFlashGet=1 Then
			If re.Test(s) Then
				Set match = re.Execute(s)
				downUrl = ServerHttp&re.Replace(match.item(0),"$4")
				downUrl = FlashgetEncode(downUrl,FlashGetID)
				Set match = Nothing
				s= re.Replace(s,"<img "& DV_UBB_TITLE &" src=""skins/default/filetype/$1.gif"" border=""0"" /><a href=""$4"" target=""_blank"">[点击浏览该文件]</a> | <img "& DV_UBB_TITLE &" src=""skins/default/fgdown.gif"" border=""0"" /><a href=""#"" onClick=""ConvertURL2FG('"&downUrl&"','"&ServerHttp&"$4',"&FlashGetID&");return false;"" fg="""&downUrl&""" oncontextmenu=""Flashget_SetHref(this)"">[快车下载]</a>")
			End If
		Else
