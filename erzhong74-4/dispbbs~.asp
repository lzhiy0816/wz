	...
	Select Case sToken
		...
		Case "moneytype"
			...
			If 0=G_Floor And G_CurrentPage=1 Then
				Select Case i
					Case 1 TPL_Echo "<div class=""info"">悬赏金币帖，要悬赏 <font color=""red"">" & G_ItemList(17, G_Floor) & "</font> 个金币</div>"
					Case 5 TPL_Echo "<div class=""info"">悬赏金币帖，要悬赏 <font color=""red"">" & G_ItemList(17, G_Floor) & "</font> 个金币[已结帖]</div>"
					Case 2 TPL_Echo "<div class=""info"">获赠金币帖，共获得 <font color=""red"">" & G_ItemList(17, G_Floor) & "</font> 个金币</div>"
					'下面这句在对body的检查中已经有了。
					'Case 3 TPL_Echo "查看本帖需支付 <font color=""red"">" & G_ItemList(17, G_Floor) & "</font> 个金币"
					Case Else
				End Select
			Else
