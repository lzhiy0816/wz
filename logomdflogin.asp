...
<%
xingming1=request.querystring("user")
exec="select * from logo where xingming='"&xingming1&"'"     ''''''''查寻网站站长的用户名(lzhiy0816 design)''''''''
...
function check() {
	...
	if(document.form1.mingchen.value == "")
	{
		alert("对不起!请输入网站名称!")
		return false
	 }
    ...
    if(document.form1.lianjie.value=="http://" || document.form1.lianjie.value=="")
	{
	    alert("对不起!请输入网站地址!")
    	return false
	 }
...
<script>
function Check(){
var Name=document.form1.xingming.value;
window.open("checkname.asp?name="+Name,"Check","width=200,height=20,status=0,scrollbars=0,resizable=1,menubar=0,toolbar=0,location=0");
}
</script>
...
<table width="100%" cellspacing="0" cellpadding="0" height="20">
  <tr> 
    ...
    <td height="20" rowspan="2" width="28%" bgcolor="#66CCFF"><!-- #BeginEditable "title1" --> 
      ...
      href="http://www.zy816.com/#" 
      onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.zy816.com/');return(false);" 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="25%" height="305" valign="top"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="150">
        <tr> 
          <td align="center"> <br>
            ...
            <form name="form1" onsubmit="return check()" method="post" action="logomdfadd.asp?id=<%=rs("id")%>">

              <TABLE cellSpacing=1 cellPadding=0 width="540" align=center border=0 height="60">
                <TBODY> 
                <TR> 
                  <td> 
                    <div align="center"> 
                      <input onclick="window.location='logo.asp'" type="button" name="Button" value="查看链接">
                    </div>
              ...
              <table width="540" border="1" cellspacing="1" cellpadding="5" align="center" bordercolor="#999999">
                <tr> 
                  <td align="center" height="20" bgcolor="#dddddd"><font face="隶书" size="5" color="#009900"><b>修改链接管理窗口</b> 
                    </font></td>
                </tr>
              </table>
              <table width="540" border="1" cellspacing="1" cellpadding="4" align="center" bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff">
                <tr>
                  <td height="20" width="100">站长姓名：</td>
                  <td height="20">
				    <input class="text" name="xingming"  maxlength="20" value="<%=rs("xingming")%>" title="！此项必须填写">
					&nbsp;<font color="#FF0000"><b>*</b></font>&nbsp;&nbsp;（限20字符）
				  </td>
                </tr>
                <tr>
                  <td height="20" width="100">新　密　码：</td>
                  <td height="20">
				    <input class="text" name="password" type="password" maxlength="50">
                    &nbsp;<font color="#FF0000"></font>&nbsp;&nbsp;（不修改密码时，可留空） 
                  </td>
                </tr>
                <tr>
                  <td height="20" width="100">确认新密码：</td>
                  <td height="20">
				    <input class="text" name="password1" type="password" maxlength="50">
                    &nbsp;<font color="#FF0000"></font> </td>
                </tr>
                <tr> 
                  <td height="20" width="100"> 网站名称： </td>
                  <td height="20"> 
                    <input class="text" name="mingchen" maxlength="9" size="16" value="<%=rs("mingchen")%>" title="！此项必须填写">
                    &nbsp;<font color="#FF0000"><b>*</b></font>&nbsp;&nbsp;（限9字符） 
                  </td>
                </tr>
                <tr> 
                  <td height="20" width="100"> 网站说明： </td>
                  <td height="20"> 
                    <input class="text" name="shuoming" maxlength="20" value="<%=rs("shuoming")%>" title="！此项必须填写">
                    &nbsp;<font color="#FF0000"><b>*</b></font>&nbsp;&nbsp;（限20字符） 
                  </td>
                </tr>
                <tr> 
                  <td height="20" width="100"> 网站网址： </td>
                  <td height="20"> 
                    <input class="text" name="lianjie" value="<%=rs("lianjie")%>" title="！此项必须填写" size="52" maxlength="100">
                    &nbsp;<font color="#FF0000"><b>*</b></font> </td>
                </tr>
                <tr> 
                  <td height="20" width="100">网站Logo图： </td>
                  <td height="20"> 
<%logoimg=rs("logoimg")
if logoimg<>"" and logoimg<>"http://" then%>
                    <input class="text" name="logoimg" value="<%=rs("logoimg")%>" size="52" maxlength="100">
<%else %>
                    <input class="text" name="logoimg" value="http://" size="52" maxlength="100">
<%end if %>
                  </td>
                </tr>
              </table>
              <table width="540" border="1" cellspacing="1" cellpadding="4" align="center" bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff" height="40">
                <tr> 
              ...
              <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" height="30">
               <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FONT color=#ff0000><b>*</b>&nbsp;：表示必填</FONT></td>
               </tr>
              </table>
