...
pagewidth=rs("pagewidthlogo")
rs.Close
set rs=nothing

exec="select * from logo Order by id desc"    ''''''''获取logo表所有用户的数据(lzhiy0816 design)''''''''
set rs=server.createobject("adodb.recordset")
rs.open exec,conn,1,1
rs.PageSize=PageSize
pagewidth=pagewidth
pageheight=rs.pagesize/pagewidth
widthdate=100/pagewidth
...
%>
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          <td>
            <div align="center"><br>
              <font face="隶书" size="6"><font color="#ff0000">欢迎</font><font color="#009900">您的网站</font><font color="#ff0000">加入</font><font color="#0000ff">链接</font></font> 
              <TABLE cellSpacing=1 cellPadding=0 width="600" align=center border=0 height="60">
                <TBODY> 
                <TR> 
                  <td> 
                    <div align="center"> 
                      <input onclick="window.location='logologin.asp'" type="button" name="Button" value="我要链接">
                    </div>
                  </td>
                  <td> 
                    <div align="center"> 
                      <input onclick="window.location='logomdf.asp'" type="button" name="Button1" value="修改链接">
                    </div>
                  </td>
                </TR>
                </TBODY> 
...
<table width="90%" border="1" cellspacing="1" cellpadding="1" align="center" bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff">

<%for j=1 to pageheight%>
<%if rs.EOF then 
        exit for
        end if%>
                <tr>
<%for i=1 to pagewidth 
if rs.EOF then%>
                  <td width="<%=widthdate%>%" height="80" align="center">&nbsp;</td>
<%else%>
                  <td width="<%=widthdate%>%" height="80" align="center">
                    <table width="100%">
                      <tr> 
                        <td width="100%" height="40" align="center">
			       	      <a href="countyour.asp?user=<%=rs("xingming")%>" target="_blank">  
					<!--  <a href="<%=rs("lianjie")%>" target="_blank">  -->
<%logoimg=rs("logoimg")
if logoimg<>"" and logoimg<>"http://" then%>
						    <img src="<%=rs("logoimg")%>" width="88" height="31" border="0" alt="<%=rs("shuoming")%>">
<%else%>
						    <img src="img/lzy/nologo.gif" width="88" height="31" border="0" alt="<%=rs("shuoming")%>">
<% end if %>
						  </a>
						</td>
                      </tr>
                      <tr> 
                        <td width="100%" height="20" align="center"> 
                          <a href="countyour.asp?user=<%=rs("xingming")%>" target="_blank">
                     <!-- <a href="<%=rs("lianjie")%>" target="_blank" title="此站站长：<%=rs("xingming")%>">  -->
						   <font color="#990000"><%=rs("mingchen")%></font> 
                          </a>
						</td>
                      </tr>
                      <tr> 
                        <td width="100%" align="center"> 
						   <font color="#009900">点击:<%=rs("countyour")%></font> 
						</td>
                      </tr>
                    </table>
                  </td>
...
<%next%>
			  ...
			  <TABLE cellSpacing=1 cellPadding=0 width="90%" align=center border=1 bordercolor="#999999">
  <TBODY> 
  <TR>
      ...
      <TABLE cellSpacing=0 cellPadding=5 width="100%" align=center 
        ...
        <TR bgColor=#dddddd> 
          <TD vAlign=bottom align=left width="76%"><FONT 
            ...
            页&nbsp;&nbsp;共有 <%=recordcount%> 个友情链接 </FONT></TD>
...
<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0 height="18">
  <TBODY> 
  <TR>
                  ...
                  border=0>
                    ...
                    <TR> 
                      ...
                      <TD align=left width="76%" >&nbsp;
                        <img src="image/icon/head.gif" width="13" height="11" border=0 alt="首页">
                        <img src="image/icon/pre.gif" width="13" height="11" border=0 alt="上一页">
                        &nbsp;
                       <font color=#000000>[ <%=page%> ]</font>&nbsp;&nbsp;
                       <a href="logo.asp?page=<%=page+1%>">
                        <img src="image/icon/next.gif" width="13" height="11" border=0 alt="下一页">
                       </a>
                       <a href="logo.asp?page=<%=pagecount%>">
                        <img src="image/icon/end.gif" width="13" height="11" border=0 alt="尾页">
                       </a>
                      </TD>
                      <TD width="24%" align=right>
                        <form name="form1" method="post" action="go(logo).asp">
			  ...
			  <table width="600">
                ...
                <tr> 
                  <td colspan="3"><b>如果贵网站的链接不是动态交互方式的，那么就请将本站手动加入到贵网站的链接中去。谢谢！</b></td>
                </tr>
                <tr> 
                  <td width="20">&nbsp;</td>
                  <td>本站名称：</td>
                ...
                <tr> 
                  <td width="20">&nbsp;</td>
                  <td>密　　码：</td>
                  <td>(如有密码请暂填，然后用Email通过我)</td>
                </tr>
                <tr> 
                  <td width="20">&nbsp;</td>
                  <td>E--mail：</td>
                  <td>lzhiy0816@163.com</td>
                </tr>
                <tr> 
                  <td width="20">&nbsp;</td>
                  <td>本站网址：</td>
<!--              <td>http://www.zy816.com</td>  -->
                  <td>http://www.zy816.com/countme.asp?user=您的网站站长名</td>
                </tr>
                <tr> 
                  <td width="20">&nbsp;</td>
                  <td>Logo图址：</td>
                  <td>http://www.zy816.com/img/logo.gif </td>
                </tr>
                <tr>
                  <td width="20">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td><img widht="88" height="31" src="img/logo.gif"  border=0></td>
                </tr>
              </table>
              <br>
			</div>
