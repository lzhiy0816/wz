  ...
  <tr> 
    <td width="25%" height="305" valign="top"><!-- #BeginEditable "title" --> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="150">
        <tr> 
          <td align="center"> 
            <TABLE cellSpacing=1 cellPadding=0 width="400" align=center border=0 height="60">
              <TBODY> 
              <TR> 
                  <td> 
                    <div align="center"> 
            ...
            <table width="400" border="1" cellspacing="1" cellpadding="5" align="center" bordercolor="#999999">
              <tr> 
                  <td align="center" height="20" bgcolor="#dddddd"><font face="隶书" size="4" color="#990000"><b>错误：用户注册</b> 
                    </font></td>
                </tr>
              </table>
<%
xingming1=request.querystring("err")
%>
            <table width="400" height="150" border="1" cellspacing="1" cellpadding="4" align="center" bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff">
              <tr> 
                <td align="center" valign="middle"> 
                  <table width="350" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40"> 错误原因： </td>
                    </tr>
                    <tr>
                      <td height="100" valign="top"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您所选的用户名"<font color="#FF0000"><%=xingming1%></font>"已经有用户使用，请另外选择一个新的用户名。 
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table width="400" border="1" cellspacing="1" cellpadding="4" align="center" bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff" height="30">
              <tr> 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td> 
                        <div align="center">
                          <input onclick="window.location='javascript:history.go(-1)'" type="button" name="again" value="重新填写">
                        </div>
                        <div align="center"> </div>
                      </td>
                    </tr>
