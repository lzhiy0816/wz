...
border=0>
              <TBODY><br><br>
              <TR>
                <TD vAlign=top align=middle><INPUT onclick="window.location='leaveword.asp'" type=button value=查看留言 name=Button3> 
...
function check(theForm,textlengh) {
	...
	if (theForm.liuyanneirong.value.length > textlengh){
        ...
        <TABLE cellSpacing=1 cellPadding=0 width="95%" align=center border=1 bordercolor="#cccccc" height="30">
          <TBODY> 
          <TR bgColor=#e7e7e7>
            <TD align=middle colSpan=2><font color="#990000"><b>网 站 管 理 员 管 理 窗 口</b></font></TD>
          </TR></TBODY></TABLE>
        <TABLE cellSpacing=1 cellPadding=5 width="95%" align=center border=0 
          ...
          <TBODY> 
              ...
              <TR bgColor=#f5f5f5>
                <TD align=middle width="20%">用户姓名：</TD>
                <TD vAlign=top width="80%"><%=rs("xingming")%></TD></TR>
              <TR bgColor=#ffffff>
                <TD align=middle width="20%">头　　像：</TD>
                <TD vAlign=top width="80%"><img src="face/<%=rs("face")%>.gif"></TD></TR>
              <TR bgColor=#f5f5f5>
                <TD align=middle width="19%">来自哪里：</TD>
                <TD vAlign=top width="81%"><%=rs("dizhi")%></TD></TR>
              <TR bgColor=#ffffff>
                <TD align=middle width="19%">IP 地 址：</TD>
                <TD vAlign=top width="81%"><%=rs("userip")%></TD></TR>
              <TR bgColor=#f5f5f5>
                <TD align=middle width="20%">电子邮件：</TD>
                <TD vAlign=top width="80%"><%=rs("email")%></TD></TR>
              <TR bgColor=#ffffff>
                <TD align=middle width="20%">用户网址：</TD>
                <TD vAlign=top width="80%"><%=rs("zhuye")%></TD></TR>
              <TR bgColor=#f5f5f5>
              ...
              <TR bgColor=#ffffff height="100">
                <TD align=middle width="20%">用户留言：</TD>
              ...
              <TR bgColor=#f5f5f5>
                ...
                <TD width="80%"><TEXTAREA name=huifu rows=6 cols=51><%=rs("huifu")%></TEXTAREA>
                <br>
                 <font color="#990000">
