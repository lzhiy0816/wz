...
%>
	  ...
	  <p>&nbsp;</p><p><STYLE type=text/css>BODY {
...
INPUT.buttom {
	BORDER-TOP-WIDTH: 1px; PADDING-RIGHT: 1px; PADDING-LEFT: 1px; BORDER-LEFT-WIDTH: 1px; FONT-SIZE: 12px; BORDER-LEFT-COLOR: #000000; BORDER-BOTTOM-WIDTH: 1px; BORDER-BOTTOM-COLOR: #000000; PADDING-BOTTOM: 1px; COLOR: #000000; BORDER-TOP-COLOR: #000000; PADDING-TOP: 1px; HEIGHT: 18px; BACKGROUND-COLOR: #dedfdf; BORDER-RIGHT-WIDTH: 1px; BORDER-RIGHT-COLOR: #000000
            ...
            </p><TABLE cellSpacing=1 cellPadding=4 width="95%" align=center 
border=0>
              <TBODY><br>
              <TR>
            ...
            <p>&nbsp;</p>
<%
''''''''====《网站管理员入口》(lzhiy0816 design)====''''''''
id=request.querystring("id")
%>

        <form name="form1" method="post" action="delcheck.asp?id=<%=id%>" >
        <TABLE cellSpacing=1 cellPadding=0 width="80%" align=center border=1 bordercolor="#cccccc" height="30">
          <TBODY> 
          <TR bgColor=#e7e7e7>
            <TD align=middle colSpan=2><font color="#990000"><b>网 站 管 理 员 入 口</b></font></TD>
          </TR></TBODY></TABLE>
        <TABLE cellSpacing=1 cellPadding=5 width="80%" align=center border=0 
            bgColor=#CCCCCC>
          <TBODY> 
          <TR bgColor=#ffffff> 
            <TD align=middle width="20%">管　理ID：</TD>
            <TD width="80%"> 
          ...
          <TR bgColor=#f5f5f5> 
            <TD align=middle width="20%">密　　码：</TD>
