...
if not session("lzychecked")="yes" then 
...
<%
exec="select * from logo where id="&id     ''''''''查寻网站站长的用户名(lzhiy0816 design)''''''''
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="150">
        <tr> 
          <td align="center"> <br>
            ...
            <form name="form1" onsubmit="return check()" method="post" action="logomdfadd.asp?id=<%=id%>">
              ...
              <table width="540" border="1" cellspacing="1" cellpadding="5" align="center" bordercolor="#999999">
                <tr> 
                  <td align="center" height="20" bgcolor="#dddddd"><font face="隶书" size="5" color="#990000"><b>lzhiy0816链接管理窗口</b> 
                    </font></td>
                </tr>
              </table>
