...
<table border="0" cellpadding=3 cellspacing=1 align="center" class=Tableborder1 Style="Width:100%">
	<tr>
	<th height=23>系统道具列表</th></tr>
	<tr><td height=23 class=Tablebody1 style="line-height: 15px"><B>说明</B>：<BR>
	1、论坛用户可通过道具中心进行论坛道具的购买、转让等操作，道具的详细使用说明点击购买后可查看<BR>
	2、金币的获取方式为论坛金钱、经验和魅力的转换，以及版主或管理员的奖励，或是会员转让和赠与<BR>
	3、道具所具备的功能、价格、使用限制等可参考相应道具的详细信息中的说明<BR>
	4、针对用户使用的道具通常是点击相应的用户进入该用户资料后点击使用道具连接再选择所使用的道具<BR>
	5、针对帖子使用的道具在进入帖子浏览页面中选择相应的道具使用图片和道具使用连接<BR>
	6、点券的获取方式为在论坛发送手机短信，得到返回验证字串后将相应点券充值到论坛帐号中，前提是论坛必须开放手机短信服务</td></tr>
	<tr><td height=23 class=Tablebody2 align="center">欢迎购买论坛道具，享受更多有趣的论坛功能！</td>
	<tr><td height=25 class=Tablebody1 align="center">
	...
	<a href="UserPay.asp"><font color=red>购买论坛点券</font></a></td>
	</tr>
</table>
		</td>
		</tr>
