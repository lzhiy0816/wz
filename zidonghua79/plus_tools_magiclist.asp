...
<tr>
<td rowspan="5" width="5"  style="border-right : 1px dotted gray;background-color:#F0F0F0;"><div align=right style="float:right;font-size:11px;word-spacing: 2;font-family:Verdana;font-weight:bold;writing-mode:tb-rl;" title="动网先锋魔法表情"><a href="http://home.dvbbs.net" target=_blank><font style="color:#CC00FF;"><font style="color:#33CCFF;">DV</font>-<font style="color:#D98200;">M</font>agic<font style="color:#D98200;">F</font>ace</font></a></div>
</td>
...
<%
	...
	If Not (Rs.Eof And Rs.Bof) Then
		...
		For i=0 To Ubound(SQL,2)
			...
			'Response.Write "<tr>"
			'Response.Write "<td align=""center"" bgcolor=""F8F8F8"" height=""47"">
