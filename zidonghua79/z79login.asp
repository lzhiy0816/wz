...
INPUT.buttom {
  ...
  <!-- form.cjs -->
  <%@language=vbscript%>
  <form name="form1" method="post" action="z79check.asp" >
    <TABLE cellSpacing=2 cellPadding=0 width="500" align=center border=1 bordercolor="#999999" height="40">
      <TBODY>
        <TR bgColor=#e7e7e7> 
          <TD align=center colSpan=2 bgcolor="#88A8D7"><font color="#FFFFFF" size="3"><strong>《自动化79论坛》登录入口</strong></font></TD>
        </TR>
      </TBODY>
    </TABLE>
      ...
      <TBODY>
        <TR> 
		  ...
		  <table width="100%" border="0">
              <TBODY>
        <TR> 
          <td><img src="images/logo.gif" width="180" height="60"></td>
            <td align="center"> 
              <table width="90%" border="0">
			    <tr>
				        <td> <font><font color="#FF0000" size="2">注：</font><font size="2">为防止无关人员进入本班论坛，设立此密码认证窗口。用户名和密码，与本班公共邮箱的用户名和密码相同</font></font> 
                        </td>
			    </tr>
			  </table>
		    </td>
      ...
      <TR> 
          ...
          <TD width="81%" height="25">　 
            <INPUT class="text" maxLength="16" 
                  size="16" name="z79password" type="password">
            </TD>
          </TR>
          <%if session("check")="z79wrong" then%>
