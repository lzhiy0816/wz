...
<tr> 
<th width="100%" class="tableHeaderText" colspan=2 height=25>动网博客系统管理
</th>
</tr>
<tr>
...
<B>管理操作选项</B></td>
<td class="forumRowHighlight"><a href="?s=8">设置</a> | 
...
<%
		...
		Pcount=Rs.PageCount
%>
<tr><td colspan=5 class=forumrow>共有<%=TotalRec%>条记录，分页：
<%
	Dim Searchstr
	Searchstr = "?s=5"
...
%>
	...
	<input type="button" name="act" value="博客用户统计" onclick="location.href='?s=9&t=1'"/>
	</td>
	<td align="left" width="90%" class="forumRow">重新统计当前博客用户总数</td>
	</tr>
	<tr>
	<td width="10%" class="forumRowHighlight">
	<input type="button" name="act" value="博客索引数据统计" onclick="location.href='?s=9&t=2'"/>
	</td>
	<td align="left" width="90%" class="forumRow">重新统计当前博客索引用户数，帖子数信息</td>
	</tr>
	<tr>
	<td width="10%" class="forumRowHighlight">
	<input type="button" name="act" value="博客话题数据统计" onclick="location.href='?s=9&t=3'"/>
	</td>
	<td align="left" width="90%" class="forumRow">重新统计当前博客话题帖子数信息</td>
	</tr>
	<tr>
	<td width="10%" class="forumRowHighlight">
	<input type="button" name="act" value="博客总数据统计" onclick="location.href='?s=9&t=4'"/>
	</td>
	<td align="left" width="90%" class="forumRow">重新统计当前博客帖子数信息</td>
	</tr>
	<tr>
	<td width="10%" class="forumRowHighlight">
	<input type="button" name="act" value="博客用户数据总更新" onclick="location.href='?s=9&t=5'"/>
	</td>
	<td align="left" width="90%" class="forumRow">更新所有博客用户的相关数据,包括文章数、评论数以及博客用户首页缓存数据等</td>
	</tr>
	</table>
<%
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align=center class="tableBorder">
<tr> 
<th width="100%" class="tableHeaderText" colspan=6 height=25 align=left ID="TableTitleLink">&nbsp;&nbsp;博客系统<%=tStr%>管理 | <a href="?s=1&t=<%=t%>&Action=Add">添加<%=tStr%></a>
</th>
</tr>
<%
...
<input type=submit name=submit value="添加博客<%=tStr%>">
</td>
</tr>
</FORM>
<%
...
<tr align=center>
<td class="forumRow" height=24 colspan=6>
<input type=submit name=submit value="编辑博客<%=tStr%>">
</td>
</tr>
</FORM>
<%
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align=center class="tableBorder">
<tr> 
<th width="100%" class="tableHeaderText" colspan=4 height=25 align=left ID="TableTitleLink">&nbsp;&nbsp;博客系统关键字管理
</th>
</tr>
...
<tr align=center>
<td class="forumRow" height=24 colspan=6>
<input type=submit name=submit value="编辑博客关键字">
</td>
</tr>
</FORM>
<%
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align=center class="tableBorder">
<tr> 
<th width="100%" class="tableHeaderText" colspan=6 height=25 align=left ID="TableTitleLink">&nbsp;&nbsp;博客系统用户栏目管理
</th>
</tr>
<tr>
<td class="forumRow" colspan=6 height=25>
...
<tr align=center>
<td class="forumRow" height=24 colspan=6>
<input type=submit name=submit value="编辑用户博客栏目">
</td>
</tr>
</FORM>
<%
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align=center class="tableBorder">
<tr> 
<th width="100%" class="tableHeaderText" colspan=6 height=25 align=left ID="TableTitleLink">&nbsp;&nbsp;博客系统用户管理
</th>
</tr>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align=center class="tableBorder">
<tr> 
<th width="100%" class="tableHeaderText" colspan=6 height=25 align=left ID="TableTitleLink">&nbsp;&nbsp;博客系统设置
</th>
</tr>
<a name="top"></a>
<tr>
...
%>
<tr> 
<td width="50%" class=Forumrow> <U>天气信息</U></td>
...
%>
<tr> 
<td width="50%" class=Forumrow> <U>新的天气</U></td>
<td width="50%" class=Forumrow>  
...
<tr> 
<td width="50%" class=Forumrow> <U>博客名称</U></td>
<td width="50%" class=Forumrow>  
<input type="text" name="BokeName" size="35" value="<%=Rs("s_name")%>">
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>博客说明</U></td>
<td width="50%" class=Forumrow>  
<textarea name="Boke_Setting(17)" cols="50" rows="3" ID="TDStopReadme"><%=Server.HtmlEncode(Boke_Setting(17)&"")%></textarea>
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>博客地址</U><BR>请填写完整URL地址，如http://www.dvbbs.net/boke/，<font color="red">不能省略最后的/号</font>，此设置将影响到Rss和Trackback的正常运行</td>
<td width="50%" class=Forumrow>  
<input type="text" name="BokeUrl" size="35" value="<%=Rs("s_url")%>">
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>二级域名根</U><BR>请按照dvbbs.net这样的形式书写，如有多个二级域名，请用“|”隔开，<font color="red">如关闭二级域名，请留空</font><BR>此设置需系统支持，填写后请阅读博客系统设置文档进行相应配置<BR>该功能正常开启状态表现为博客用户可根据“用户博客标识.二级域名根”进入自己的博客，如：shatan.dvbbs.net<BR>如系统不支持二级域名设置，可以到 <a href="http://domain.iboker.com/reg.asp" target=_blank>domain.iboker.com</a> 免费申请</td>
<td width="50%" class=Forumrow>  
...
<tr> 
<td width="50%" class=Forumrow> <U>新用户申请</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(0)" value=0 <%if Boke_Setting(0)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(0)" value=1 <%if Boke_Setting(0)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>是否开启全文搜索</U>(建议关闭)</td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(1)" value=0 <%if Boke_Setting(1)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(1)" value=1 <%if Boke_Setting(1)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>游客发表评论</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(2)" value=0 <%if Boke_Setting(2)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(2)" value=1 <%if Boke_Setting(2)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>用户注册验证码</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(3)" value=0 <%if Boke_Setting(3)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(3)" value=1 <%if Boke_Setting(3)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>新文章验证码</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(4)" value=0 <%if Boke_Setting(4)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(4)" value=1 <%if Boke_Setting(4)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>评论验证码</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(5)" value=0 <%if Boke_Setting(5)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(5)" value=1 <%if Boke_Setting(5)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>新文章、评论时间间隔</U></td>
<td width="50%" class=Forumrow>  
<input type="text" name="Boke_Setting(6)" size="35" value="<%=Boke_Setting(6)%>"> 秒
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>默认分页信息数</U></td>
<td width="50%" class=Forumrow>  
<input type="text" name="Boke_Setting(7)" size="35" value="<%=Boke_Setting(7)%>"> 条
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>相片分页信息数</U></td>
<td width="50%" class=Forumrow>  
<input type="text" name="Boke_Setting(8)" size="35" value="<%=Boke_Setting(8)%>"> 张
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>每行相片数</U></td>
<td width="50%" class=Forumrow>  
<input type="text" name="Boke_Setting(9)" size="35" value="<%=Boke_Setting(9)%>"> 张
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>图片自动按比例缩放</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(10)" value=0 <%if Boke_Setting(10)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(10)" value=1 <%if Boke_Setting(10)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>图片按滚轮缩放</U></td>
<td width="50%" class=Forumrow>  
<input type=radio name="Boke_Setting(11)" value=0 <%if Boke_Setting(11)="0" then%>checked<%end if%>>关闭&nbsp;
<input type=radio name="Boke_Setting(11)" value=1 <%if Boke_Setting(11)="1" then%>checked<%end if%>>开启&nbsp;
</td>
</tr>
<tr> 
<td width="50%" class=Forumrow> <U>用户上传空间大小</U></td>
<td width="50%" class=Forumrow>  
...
<tr> 
	<td width="50%" class=Forumrow> <U>用户上传设置沿用用户组默认设置</U><BR>建议开启，开启后沿用不同用户组的是否允许上传及上传文件大小限制</td>
	<td width="43%" class=Forumrow>
<input type=radio name="UploadSetting(0)" value=0 <%if UploadSetting(0)="0" then%>checked<%end if%>>否&nbsp;
<input type=radio name="UploadSetting(0)" value=1 <%if UploadSetting(0)="1" then%>checked<%end if%>>是&nbsp;
	</td>
</tr>
<tr> 
	<td class=ForumRowHighlight><U>用户上传文件大小</U><BR>设置后将不沿用用户的用户组上传设置，所有用户组都将使用此设置</td>
	<td class=ForumRowHighlight> 
	<input type="text" name="UploadSetting(1)" size="6" value="<%=UploadSetting(1)%>">&nbsp;K
	</td>
</tr>
<tr> 
<td class=Forumrow> <U>上传文件限制</U><br>(文件后缀名，以"|"分隔)</td>
<td class=Forumrow>  
...
<td class=ForumRow>
<input type=radio name="UploadSetting(20)" value=0 <%if UploadSetting(20)="0" Then %>checked<%end if%>>关闭&nbsp;
<input type=radio name="UploadSetting(20)" value=1 <%if UploadSetting(20)="1" Then %>checked<%end if%>>打开&nbsp;
</td>
</tr>
<tr> 
...
Sub Dv_suc(info)
	...
	Response.Write"</td></tr>"
	Response.Write"<tr>"
	Response.Write"<td class=""forumRowHighlight"" valign=middle colspan=2 align=center><a href=""javascript:history.go(-1)"" ><<返回上一页</a></td></tr>"
	Response.Write"</table>"
End Sub
