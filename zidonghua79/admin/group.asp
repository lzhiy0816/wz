...
<tr> 
<th height="23" align=left>&nbsp;操作提示</th>
</tr>
<tr align=left>
<td height="23" class="Forumrow" style="LINE-HEIGHT: 140%">
...
<tr align=left>
<td height="23" class="forumrowHighlight" style="LINE-HEIGHT: 140%">
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr> 
<th height="23" align=left colspan="6">注册用户组(等级)管理</th>
</tr>
...
<td class=Forumrow><input size=5 value="<%=rs("MinArticle")%>" name="minarticle" type=text ></td>
<td class=Forumrow><input size=15 value="<%=rs("grouppic")%>" name="titlepic" type=text><img src="../<%=Dvbbs.Forum_PicUrl%>star/<%=rs("grouppic")%>" border="0"></td>
<td class=Forumrow>
<B><%
...
<td class=Forumrow><input size=5 value="0" name="minarticle" type=text ></td>
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr> 
<th height="23" align=left colspan="6">系统用户组管理<a name="1"></a></th>
</tr>
<tr><td colspan=6 height=25 class="Forumrow">
...
<td class=Forumrow><a href="?action=editgroup&groupid=<%=rs("UserGroupID")%>">编辑</a> | <a href="user.asp?action=userSearch&userSearch=10&usergroupid=<%=rs("usergroupid")%>">列出用户</a></td>
</tr>
<%
Rs.MoveNext
Loop
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr> 
<th height="23" align=left colspan="6">特殊用户组管理<a name="2"></a></th>
</tr>
<tr><td colspan=6 height=25 class="Forumrow">
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr> 
<th height="23" align=left colspan="7">多属性用户组管理<a name="3"></a></th>
</tr>
<tr><td colspan=7 height=25 class="Forumrow">
...
<tr><td colspan=4 height=25 class="Forumrow">
<b>批量更新用户组设置</b>：<input type="button" value="选择用户组" onclick="getGroup('Select_Group');">
</td></tr>
<tr>
<th height="23" colspan="4" align=left>
<a name="setting1"></a>
...
<tr>
<td width="1%" class=Forumrow></td>
<td height="23" class=Forumrow>用户组(等级)名称</td>
<td height="23" class=Forumrow colspan=2><input size=35 name="title" type=text value="<%=Rs("UserTitle")%>"></td>
</tr>
<tr>
<td width="1%" class=Forumrow><INPUT TYPE="checkbox" NAME="CheckGroupPic"></td>
<td height="23" class=Forumrow>用户组(等级)图片</td>
<td height="23"class=Forumrow colspan=2><input size=35 name="grouppic" type=text value="<%=rs("grouppic")%>"></td>
</tr>
<%
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr> 
<th height="23" align=left colspan=3>用户组在线图例管理</th>
</tr>
<tr> 
...
End Sub
Sub SaveGroupOnline()
	Dim UserTitleID,Orders,TitlePic
	For i=1 To Request.Form("usertitleid").Count
		UserTitleID=Replace(Request.Form("usertitleid")(i),"'","")
