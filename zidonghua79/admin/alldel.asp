...
<form action="alldel.asp?action=delUser" method="post">
            <tr>
            <th valign=middle colspan=2 height=23 align=left>删除指定日期内没有登录的用户</td></tr>
            <tr>
            <tr>
            <td class=forumrow valign=middle>指定日期</td>
...
<form action="alldel.asp?action=MoveDateTopic" method="post">
            ...
            <tr>
            <td valign=middle width=40% class=forumrow>移动多少天前的帖子(填写数字)<li>填写为0，即分版所有帖子。</td><td class=forumrow><input name="TimeLimited" value=0 size=30>天&nbsp;<input type=submit name="submit" value="提 交"></td></tr>
            <tr>
