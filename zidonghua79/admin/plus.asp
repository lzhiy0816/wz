...
<tr><td height="23" colspan="2" class=forumrow>能使用插件的用户组&nbsp;&nbsp; 
<input type=text name="groupid" value="<%=Replace(Groupids&"","@",",")%>" size=30>这里设置可以使用插件的用户组
<input type="button" value="选择用户组" onclick="getGroup('Select_Group');">
</td></tr>
...
<tr>
<td height="23" colspan="5" class=forumrow><a href="plus.asp?action=AddNew">新建菜单</a> | <a href="plus.asp?action=posttodb">导出插件模板数据</a> | <a href="plus.asp?action=getfromdb">导入插件模板数据</a></td>
</tr>
<tr>
<th height="23">标题</th>
<th>分类</th>
