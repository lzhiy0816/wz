...
<td class="forumRow" width="80%"><%=Rs("UserName")%></td>
</tr>
<tr>
<td class="forumRow" width="20%" align=right><B>最后操作时间</B>：</td>
<td class="forumRow" width="80%"><%=Rs("UpdateTime")%></td>
</tr>
<tr>
<td class="forumRow" width="20%" align=right><B>可使用数量</B>：</td>
<td class="forumRow" width="80%"><input type=text size=10 value="<%=Rs("ToolsCount")%>" name="ToolsCount"> 个</td>
</tr>
<tr>
<td class="forumRow" width="20%" align=right><B>出售中数量</B>：</td>
<td class="forumRow" width="80%"><input type=text size=10 value="<%=Rs("SaleCount")%>" name="SaleCount"> 个</td>
</tr>
<tr>
<td class="forumRow" width="20%" align=right><B>出售价格（金币）</B>：</td>
<td class="forumRow" width="80%"><input type=text size=10 value="<%=Rs("SaleMoney")%>" name="SaleMoney"> 个</td>
</tr>
<tr>
<td class="forumRow" width="20%" align=right><B>出售价格（点券）</B>：</td>
<td class="forumRow" width="80%"><input type=text size=10 value="<%=Rs("SaleTicket")%>" name="SaleTicket"> 张</td>
</tr>
<tr><td class="forumRowHighlight" colspan=2 align=center>
...
<tr><th height=24 colspan=2>给用户赠送道具</th></tr>
<tr><td height=24 class="forumRow" colspan=2>说明：部分系统不出售的内部道具请慎重赠送</td></tr>
<tr>
<td class="forumRow" width="30%" align=right>
<B>道具名称</B>：
</td>
...
<tr><td height=24 class="forumRow" colspan=2 align=center><input type=submit name=submit value="送出道具或金币"></td></tr>
</form>
</table>
<%
End Sub
