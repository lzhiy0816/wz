...
&nbsp;<input type="radio" name="searchWhat" value="username" checked>用户&nbsp;<input type="radio" name="searchWhat" value="topic">主题&nbsp;<input type="submit" name="submit" value="搜索"></td>
</tr>
</FORM>
<tr> 
...
%>
 ...
 <input type="radio" name="TopOrEnd" value="Top" checked>前 <input type="radio" name="TopOrEnd" value="End">后 <input type=text name="selnum" value="100" size=3>条 记录转移到
...
<td width="15%" class=Forumrow align=center><a href="user.asp?action=modify&userid=<%=rs("postuserid")%>"><%=dvbbs.htmlencode(rs("postusername"))%></a></td>
