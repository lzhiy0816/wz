...
<tr><th>魔法表情（头像）设置和管理</th></tr>
<tr><td class="forumRowHighlight" style="line-height: 130%"><B>魔法表情（头像）设置和管理</B>：<BR>
	...
	<BR>
	2、您可以分别设定使用每个魔法表情所需要的金币和点券数，所设置的金币和点券数为用户购买需要。可设置使用每个魔法表情（头像）需要的帖子、金钱、经验、魅力、威望数限制，这些只是限制达到此标准的才能使用，并不扣除相应设置的数值。</td></tr>
</table>
<br>
<%
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr>
<td class="forumRow" colspan=15 style="line-height: 130%">
...
<tr align=center>
<td class="forumRowHighlight"><font color=red>新</font></td>
<td class="forumRowHighlight"></td>
<td class="forumRowHighlight"><input type=text size=13 name="ntitle"></td>
...
<td class="forumRowHighlight"><input type=text size=6 name="ngif" value="0"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nmoney" value="1000"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nticket" value="100"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntmoney" value="100"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntticket" value="10"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntopic" value="10"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nwealth" value="100"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nuserep" value="20"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nusercp" value="10"></td>
<td class="forumRowHighlight"><input type=text size=3 name="npower" value="0"></td>
<td class="forumRowHighlight"><input type=submit name=submit value="添加"></td>
</tr>
</FORM>
<%
...
<tr align=center>
<td class="forumRowHighlight"><%=SQL(0,i)%></td>
<td class="forumRowHighlight"><a href="../Dv_plus/Tools/magicface/swf/<%=SQL(3,i)%>.swf" target=_blank><img src="../Dv_plus/Tools/magicface/gif/<%=SQL(2,i)%>.gif" border=0></a></td>
<td class="forumRowHighlight"><input type=text size=13 name="ntitle" value="<%=SQL(1,i)%>"></td>
<td class="forumRowHighlight">
<Select Name="ntype" size=1>
<%
...
<td class="forumRowHighlight"><input type=text size=6 name="ngif" value="<%=SQL(2,i)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nmoney" value="<%=SQL(5,i)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nticket" value="<%=SQL(6,i)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntmoney" value="<%=SQL(8,i)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntticket" value="<%=SQL(9,i)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="ntopic" value="<%=MagicSetting(0)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nwealth" value="<%=MagicSetting(1)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nuserep" value="<%=MagicSetting(2)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="nusercp" value="<%=MagicSetting(3)%>"></td>
<td class="forumRowHighlight"><input type=text size=3 name="npower" value="<%=MagicSetting(4)%>"></td>
<td class="forumRowHighlight"><input type=checkbox name="ID" value="<%=SQL(0,i)%>"></td>
</tr>
<%
	Next
End If
...
%>
<tr>
<td class="forumRow" colspan=15 align=right height="30">
请选中指定的魔法表情进行修改或删除操作&nbsp;&nbsp;全选<input name=chkall type=checkbox value=on	onclick="CheckAll(this.form)">&nbsp;&nbsp;<input type=submit name=submit value="修改">&nbsp;<input type=submit name=submit value="删除">
</td>
</tr>
</FORM>
</table>
...
Sub Addnew()
	...
	If Request("nuserep")="" Or Not IsNumeric(Request("nuserep")) Then
		Errmsg=ErrMsg + "<BR><li>请输入魔法表情需要的经验数。"
		founderr=True
	End If
