...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr>
<th colspan=2 align=left height=23>注册限制设置</th>
</tr>
<tr>
<td class=forumrow width="20%">说明：</td>
<td class=forumrow width="80%">扩展注册设置,请根据自己需要设置.</td>
</tr>
<tr>
<%
nodename="checkip"
...
End If
%>
<td class=forumrow width="20%">采用IP策略</td>
<td class=forumrow width="80%"><input type="checkbox" value="1" name="<%=nodename%>" <%=checkedstr %>  /> 如果不选择,所有和IP地址有关的设置都不起作用.</td>
</tr>
<tr>
<td class=forumrow width="20%">允许注册IP(IP白名单)<br>
...
<tr>
<td class=forumrow width="20%">禁止注册IP(ip黑名单)<br>
填写可以注册的IP地址,格式是IP地址=说明,每个用换行分开
...
%>
<tr>
<td class=forumrow width="20%">如IP受限制提交IP来源信息</td>
<td class=forumrow width="80%">
<input type="checkbox" value="1" name="<%=nodename%>" <%=checkedstr %> /><br> 如果注册用户所在IP不在允许注册之列,可以引导注册者进入提交当前IP信息的页面,以便管理员可以增加该段IP地址的许可.
</td>
</tr>
<%
...
%>
<tr>
<td class=forumrow width="20%">一个IP地址一天可以注册次数</td>
<td class=forumrow width="80%"><input type="text" Size="4" value="<%=checkedstr %>" name="<%=nodename%>"  />请填写数字否则会出错,如不想限制,请填写0</td>
</tr>
<%
...
%>
<tr>
<td class=forumrow width="20%">禁止纯数字ID注册</td>
<td class=forumrow width="80%"><input type="checkbox" value="1" name="<%=nodename%>" <%=checkedstr %> />是否允许采用纯数的用户名注册</td>
</tr>
<%
nodename="checktime"
Set Node=XMLDom.documentElement.selectSingleNode("@"&nodename)
...
%>
<tr>
<td class=forumrow width="20%">要求输入当前时间</td>
<td class=forumrow width="80%"><Input type="checkbox" value="1" name="<%=nodename%>" <%=checkedstr %> /><br>如果启用,要求用户选择自己所在时区和输入他所在地的时间(以小时为单位)</td>
</tr>
<%
nodename="usevarform"
Set Node=XMLDom.documentElement.selectSingleNode("@"&nodename)
...
%>
<tr>
<td class=forumrow width="20%">采用动态的表单项目名称</td>
<td class=forumrow width="80%"><input type="checkbox" value="1" name="<%=nodename%>" <%=checkedstr %> />采用不定名的表单项目名称,增加机器人注册的难度.</td>
</tr>
<%end if%>
