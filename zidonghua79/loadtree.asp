...
Sub Showtree()
	...
	If TotalUseTable <>"" Then 
		...
		Set rs=Nothing 
	End If
	template.html(2)=Replace(template.html(2),"{$treeloop}",tmpstr)
	Response.Write "<script language=""javascript"">"
	Response.Write Chr(10)
	Response.Write "var treedata='"
	Response.Write Replace(Replace(Replace(Replace(template.html(2),"\","\\"),"'","\'"),VbCrLf,"\n"),chr(10),"")
	Response.Write "';"
	Response.Write vbNewLine
...
%>
	...
	<!--
		PageList(<%=Star%>,10,<%=Cint(Dvbbs.Board_Setting(27))%>,<%=Record_Count%>,'<%=Search%>',3)
	//-->
	</SCRIPT>
	</span>
	<SCRIPT LANGUAGE="JavaScript">
