...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="25%" height="305" valign="middle">
...
<%id=request.querystring("id")%>
            <form name="form1" method="post" action="logolzymdfcheck.asp?id=<%=id%>">
              <TABLE cellSpacing=1 cellPadding=0 width="65%" align=center border=1 bordercolor="#999999" height="30">
      <TBODY> 
      <TR bgColor=#e7e7e7>
            
        <TD align=middle colSpan=2 bgcolor="#dddddd"><font color="#990000"><b>lzhiy0816 验 证</b></font></TD>
          </TR></TBODY></TABLE>
    ...
    <TABLE cellSpacing=1 cellPadding=5 width="65%" align=center border=1 bordercolor="#999999" bordercolorlight="#999999" bordercolordark="#ffffff">
      <TBODY> 
      <TR> 
        <TD align=middle width="19%">lzhiy0816：</TD>
            
        <TD width="81%"> 
          <INPUT class="text" maxLength="20"
                  name="xingming">
            </TD>
          </TR>
      ...
      <TR> 
        ...
        <TD vAlign=top width="81%"> 
          <INPUT class="text" maxLength="50" 
                  name="password" type="password">
        </TD>
      </TR>

<%if session("lzycheck")="wrong" then%>
      <TR> 
